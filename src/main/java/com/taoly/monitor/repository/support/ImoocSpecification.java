...
public abstract class ImoocSpecification<T, C> extends AbstractEventConditionBuilder<T, C>
    ...
    public Predicate toPredicate(Root<T> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
        ...
        QueryWraper<T> orQueryWraper = new QueryWraper<T>(root, query, cb, orPredicates);
        orCondition(orQueryWraper);
...
//        System.out.println("getPermissionCondition");
        return null;
    }
    ...
    protected void orCondition(QueryWraper<T> queryWraper) {
