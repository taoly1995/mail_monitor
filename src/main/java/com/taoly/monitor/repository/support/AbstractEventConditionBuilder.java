...
public abstract class AbstractEventConditionBuilder<T, C> extends AbstractConditionBuilder<T> {
     ...
     *
     * @param queryWraper
     * @param field       如果不为null，则equal、如果null则isNull
     * @throws NoSuchMethodException
     * @throws InvocationTargetException
     * @throws IllegalAccessException
     */
    protected void addEqualOrIsNullCondition(QueryWraper<T> queryWraper, String field) {
        if (needAddCondition(getValue(getCondition(), field))) {
            addEqualsConditionToColumn(queryWraper, field,
                    getValue(getCondition(), field));
        } else {
            addIsNullConditionToColumn(queryWraper, field);
        }
    }
...
//     * @param field
//     */
//    protected void addOrLikeCondition(QueryWraper<T> queryWraper, String field) {
//        addOrLikeCondition(queryWraper, field, field);
//    }
//
//    protected void addOrLikeCondition(QueryWraper<T> queryWraper, String field, String column) {
//        addOrLikeConditionToColumn(queryWraper, column, (String)
//                getValue(getCondition(), field));
//    }
